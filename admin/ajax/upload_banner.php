...
if ($_FILES["fileToUpload"]["size"] > 4000000) {
    $errors[]= "Lo sentimos, el archivo es demasiado grande.  Tamaño máximo admitido: 2.0 MB";
    $uploadOk = 0;
}
...
if ($uploadOk == 0) {
    ...
    if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
	 ...
	 $update=mysqli_query($conn,"UPDATE banner SET url_image='$ruta' WHERE id='$id_banner'");
